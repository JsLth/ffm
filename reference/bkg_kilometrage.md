...
for each kilometer of a highway. They can be used to create linear
referencing systems (LRS).
...
The [`rLFT`](https://cran.r-project.org/package=rLFT) package for linear
referencing
